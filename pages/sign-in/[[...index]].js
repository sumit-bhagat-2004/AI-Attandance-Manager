...
export default function SignInPage() {
    ...
    useEffect(() => {
        // Show PWA install card after 5 seconds on sign-in page
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="text-center mb-8">
                        ...
                        >
                            ...
                            Please use your <strong>@aot.edu.in</strong> email address to sign in.<br/>
                    ...
                    {/* Clerk Sign In Component with Better Visibility */}
